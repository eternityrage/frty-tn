...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "💬 FruityToon Daily!\n\n#fruitytoon #funny #nutrition"
        ...
        video = upload.video(
            ...
            name=title or 'FruityToon Video',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Daily FruityToon Comedy! 😂"
    title = sys.argv[3] if len(sys.argv) > 3 else "FruityToon"
